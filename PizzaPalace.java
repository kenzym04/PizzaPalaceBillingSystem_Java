...
public class PizzaCalculator extends JFrame implements ActionListener {
    ...
    JCheckBox Mushrooms = new JCheckBox("Ham");
    JCheckBox Salami = new JCheckBox("Feta Cheese");
    JCheckBox Anchovies = new JCheckBox("Tomatoes");
JCheckBox Anchovies = new JCheckBox("Pineapple");
JCheckBox Anchovies = new JCheckBox("Olives");
